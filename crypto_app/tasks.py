...
def db_filling():
    ...
    for key in cpcurr_code.items():
        for elem in curr_code.items():
            ...
            response = requests.get(url=url, headers={'User-Agent': 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:97.0) Gecko/20100101 Firefox/97.0','X-Requested-With': 'XMLHttpRequest'})
